...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    "font-medium rounded-md border focus:outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer";
  ...
  const variantClasses = {
    ...
    secondary:
      "bg-mid-gray/10 border-mid-gray/80 hover:bg-background-ui/30 hover:border-logo-primary focus:outline-none",
    danger:
